...
def computeAreaCbox(Cbox, ndiscretePoints):
...
def addCbox(Cbox1, Cbox2, npoints = 100, show_plot = False):   
    ...
    if Cbox1.get('betaparam') == 'unknown' and Cbox2.get('betaparam') == 'unknown':
        ...
        focal_element_Cbox2 = [[lf, rf] for lf, rf in zip(left_fe_cb2[0], right_fe_cb2[0])]
...
def subtractCbox(Cbox1, Cbox2, npoints = 100, show_plot = False):
    ...
    if Cbox1.get('betaparam') == 'unknown' and Cbox2.get('betaparam') == 'unknown':
        ...
        focal_element_Cbox1 = [[lf, rf] for lf, rf in zip(left_fe_cb1[0], right_fe_cb1[0])] 
        focal_element_Cbox2 = [[lf, rf] for lf, rf in zip(left_fe_cb2[0], right_fe_cb2[0])]
